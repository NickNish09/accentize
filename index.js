function substituteCharacterForRegex(chr) {
    ...
    if (defaultDiacriticsRemovalMap[chr] !== undefined)
      return defaultDiacriticsRemovalMap[chr];
  ...
  function test(){
    ...
    let arrayOfQueries = "batata rustica com pure de mandioca".toLowerCase().split(" ");
    let queryRegex = ".*";
    ...
    console.log(test_string.match(regex))
  }
